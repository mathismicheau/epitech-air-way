export const translations = {
  en: {
    ...
    featAirbnbTitle: "Hotel Stays",
    featAirbnbDesc: "Wingman analyzes thousands of listings to suggest the ideal hotel based on your budget and style.",
    ...
    quit: "← Leave Terminal",
    placeholder: "Ask about flights, Hotelss or activities...",
  ...
  fr: {
    ...
    featAirbnbTitle: "Hébergements Hotel",

export const translations = {
  en: {
    heroTitle: "Wingman",
    heroSubtitle: "Your AI co-pilot for the perfect trip. Now finding the best Hotels and local activities for you.",
    ...
    featHotelsTitle: "Hotels Stays",
    featAirbnbDesc: "Wingman analyzes thousands of listings to suggest the ideal Hotels based on your budget and style.",
    ...
    welcomeMsg: "Welcome aboard! I'm Wingman. I can find Hotels, activities, or help with your flight. Where to?",
    quickActionAirbnb: "Find Hotels 🏠",
    quickActionActivities: "Things to do 🎡",
    newFlight: "+ NEW FLIGHT",
    flightLogs: "FLIGHT LOGS",
    noLogs: "No recent logs",
    quit: "← Leave Terminal",
    placeholder: "Ask about flights, Hotels or activities...",
  ...
  fr: {
    heroTitle: "Wingman",
    heroSubtitle: "Votre co-pilote IA pour un voyage parfait. Trouvez les meilleurs Hotels et activités locales.",
    ...
    featAirbnbTitle: "Hébergements Hotels",
    featAirbnbDesc: "Wingman suggère l'hotel idéal selon votre budget et vos envies.",
    featAirbnbImg: "https://images.pexels.com/photos/276724/pexels-photo-276724.jpeg?auto=compress&cs=tinysrgb&w=800",
    ...
    welcomeMsg: "Bienvenue à bord ! Je suis Wingman. Je peux trouver des Hotels ou gérer votre vol. On va où ?",
    quickActionAirbnb: "Trouver un Hotel 🏠",
    ...
    placeholder: "Vols, Hotels ou activités...",
